...
//	private PlayerRepository playerRepository;
	...
	public void InstanciaDB() {
		...
		Team tm1 = new Team(1, "São Paulo Futebol Clube", "São Paulo", null, "SPFC", "Santo Paulo", "São Paulo", "SP",
		...
		Team tm2 = new Team(2, "Clube de Regatas Flamento", "Flamengo", null, "CRF", "Ninho do Urubu", "Rio de Janeiro",
				"RJ",
				"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Flamengo_braz_logo.svg/800px-Flamengo_braz_logo.svg.png",
				true, null, null, null, null);
		Team tm3 = new Team(3, "Cruzeiro Futebol Clube", "Cruzeiro", null, "CFC", "Toca da Raposa", "Belo Hotizonte",
				"MG",
		...
		Team tm5 = new Team(5, "Grêmio Football Portoalegrense", "Grêmio", null, "GFPA", "Olímpico", "Porto Alegre",
				"RS", "https://upload.wikimedia.org/wikipedia/it/thumb/f/f1/Gremio.svg/1200px-Gremio.svg.png", true,
				null, null, null, null);
		...
		Team tm6 = new Team(6, "Sport Clube Internacional", "Inter", null, "SCI", "Gigante da Beira Rio",
				...
				true, null, null, null, null);
		Team tm7 = new Team(7, "Esporte Clube Bahia", "Bahia", null, "ECB", "Arena Fonte Nova", "Bahia", "BA",
				"https://upload.wikimedia.org/wikipedia/en/thumb/2/2c/Esporte_Clube_Bahia_logo.svg/1200px-Esporte_Clube_Bahia_logo.svg.png",
				true, null, null, null, null);

		Team tm8 = new Team(8, "Goiás Esporte Clube", "Goiás", null, "GEC", "Serra Dourada", "Goiás", "GO",
				"https://upload.wikimedia.org/wikipedia/commons/f/ff/Goi%C3%A1sLogo21.png", true, null, null, null,
				null);

		Team tm9 = new Team(9, "Sport Club do Recife", "Sport", null, "SCS", "Ilha do Retiro", "Recife", "PE",
		...
		Player p1 = new Player(null, "Alexandre Guedes", "Kokhym", null, 5, true, "000.000.000-00", "00.000.000-X",
				null, "São Paulo", null);
