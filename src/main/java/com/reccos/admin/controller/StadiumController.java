...
public class StadiumController {
	...
	public ResponseEntity<Stadium> listById(@PathVariable Long id) {
		Stadium arbitro = service.listById(id);
	...
	@PostMapping
    public ResponseEntity<Stadium> saveLeague(@RequestBody Stadium stadium) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Stadium> atualizarStadium(@PathVariable Long id, @RequestBody Stadium arbitro){
		Stadium obj = service.update(id, arbitro);
